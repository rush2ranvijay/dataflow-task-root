...
from task_ops.base.secrets import NoopSecretVault
from task_ops.base.vault import new_secret_vault
from task_ops.exceptions import BadInterpolationException
...
class PropertySource(abc.ABC):
    """
    PropertySource abstract the property sources to provide the application wide properties
    """
